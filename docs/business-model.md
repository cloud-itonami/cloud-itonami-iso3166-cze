# Business Model: Independent Public-Sector Market-Entry & Procurement Compliance Service — Czech Republic

## Classification

- Repository: `cloud-itonami-iso3166-cze`
- ISO 3166: `CZE` (Czech Republic)
...
- an already-incorporated `cloud-itonami-cofog-{code}` /
  ...
  `cloud-itonami-{ISIC}` operator wanting to bid on a Czech
  public contract
...
- registration walkthrough for NEN (Národní elektronický nástroj /
  National Electronic Tool, nen.nipez.cz), the free certified
  e-procurement tool under the NIPEZ Information System on Public
  Contracts for tender publication, bidding and dynamic purchasing
  systems
- business/tax registration checklist: an entry in the Obchodní rejstřík
  (Commercial Register), part of the Veřejný rejstřík (Public Register)
  administered by the Ministry of Justice, searchable at or.justice.cz
- local-content / preferential-procurement navigation: EU-wide open
  ...
  member state), but Czech-language submission and an EU/EEA address for
  service are typically required
...
- this service does **not** provide legal or tax advice; characterization
  ...
  routes to Czech-licensed counsel or a registered agent
...
- **`cloud-itonami-cofog-{code}`**: a jurisdiction-agnostic operator
  ...
  blueprint AND this one to operate in the Czech Republic).
