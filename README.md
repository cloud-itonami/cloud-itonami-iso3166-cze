# cloud-itonami-iso3166-cze

Open ISO 3166 Blueprint for **CZE**: Czech Republic.
...
tax registration, and EU single-market rules in the Czech Republic, so
...
- **Not the government of the Czech Republic.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Czech-licensed counsel
...
(ISO 3166 `CZE`). Required capabilities:
