(ns marketentry.store
  "SSoT for the CZE market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems CZ" :portal "NEN"
             ...
             :jurisdiction "CZE" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "NEN"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-ico? true :ico-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "NEN"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "CZE" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "NEN"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "CZE" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "NEN"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "CZE" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "NEN"
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-cze"})
